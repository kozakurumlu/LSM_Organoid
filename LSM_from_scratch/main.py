...
if __name__ == '__main__':
    ...
    # === IMPORTANT: For this run, delete your old .npy files first! ===
    if os.path.exists(RESERVOIR_DATA_PATH):
        ...
        for trial_num in tqdm(range(NUM_TRIALS)):
            ...
            # === PARAMETER FIX: Use a more balanced set of weights ===
            ...
            # --- DIAGNOSTIC: Plot reservoir activity for the first trial ---
            if trial_num == 0:
                plot_reservoir_activity(lsm_network.spike_recorder, TRIAL_DURATION, N_RESERVOIR)
